...
export default function AdminDutyWeek() {
  usePageTitle("EDP | Phiếu trực theo tuần")
  ...
  async function deleteSession(id: number) {
    ...
    setDetailId(null)
    setDetail(null)
    if (weekId != null) await load(weekId)
  }
        ...
        <div className="edp-glass-panel rounded-[32px] p-5 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <div>
              ...
              <div className="text-sm text-gray-600">Theo tuần</div>
              {selectedWeek ? (
          ...
          <div className="edp-glass-panel rounded-[32px] p-0 overflow-hidden">
            ...
            {sessions.length === 0 ? (
              <div className="px-5 pb-6 text-sm text-gray-600">
                Chưa có phiếu trực trong tuần này.
              </div>
            ) : (
                    ...
                    <div className="flex items-start gap-3">
                      <div className="min-w-0 flex-1">
                        <div className="text-[15px] font-semibold text-gray-900">
                          {s.date}: {s.red_class} trực {s.duty_class}
                        </div>
